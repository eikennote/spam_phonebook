...
class PhoneNumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone_number" do
    assert_difference("PhoneNumber.count") do
      post phone_numbers_url, params: { phone_number: { count: @phone_number.count, description: @phone_number.description, number: @phone_number.number } }
    end
  ...
  test "should update phone_number" do
    patch phone_number_url(@phone_number), params: { phone_number: { count: @phone_number.count, description: @phone_number.description, number: @phone_number.number } }
